...
/**
 * Vista para Carga Masiva de Usuarios
 * 
 * Interfaz de usuario para carga masiva de usuarios
 * 
...
<?php if (!empty($mensaje) || !empty($tipoMensaje) || $pg == 2114): ?>
    <?php
    $estadoReal = 'info';
    ...
    $configuracion = [
        'success' => [
            ...
            'titulo' => '¡Carga Masiva Completada Exitosamente!'
        ],
        'warning' => [
            'fondo' => '#fff3cd',
            'borde' => '#ffeaa7',
            ...
            'titulo' => 'Carga Masiva Completada con Advertencias'
        ],
        'danger' => [
            'fondo' => '#f8d7da',
            'borde' => '#f5c6cb',
            ...
            'titulo' => 'Error en el Procesamiento de Carga Masiva'
        ],
        'info' => [
            'fondo' => '#e2e3e5',
            'borde' => '#d1d3d4',
            ...
            'titulo' => 'Procesamiento Completado - Sin Cambios'
        ]
    ];
    ...
    echo titulo2("<i class='fa-solid fa-file-import'></i> Resultado de Carga Masiva", 0);
    ?>
...
<!-- Modal -->
<div class="modal fade" id="modalCmausu" tabindex="-1" aria-labelledby="modalCmausuLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalCmausuLabel">Carga Masiva de Usuarios</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="home.php?pg=2114" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    ?>
                    <input type="hidden" name="pg" value="2114">

...
<?php if(!$ndocusu){ ?>
	<form class="m-tb-40 form-reg-ES" action="<?=$direc;?>" method="POST" enctype="multipart/form-data">
		<div class="row">
			...
			<div class="form-group col-md-6 frob" id="go1" style="text-align: center;">
				<br><br>
				<label for="ndocusu" class="fs-2 text-black fw-semibold">Número de documento</label>
				<input type="number" class="form-control form--input-default" id="ndocusu" maxlength="100" name="ndocusu"
					required onchange="this.form.submit();" placeholder="Ej. 10000000" autofocus />
				...
				<?php }else{ ?>
					<div class="form-group col-md-6" id="go1" style="margin: 0 auto;">
						<a href="home.php?pg=1325">
							<button type="button" class="btn btn-primary" style="font-size: 20px;width: 100%;background-color: #00af00; margin-bottom: 2%;">Volver Sin Registro</button>
						</a>
					</div>
					<div class="form-group col-md-6" id="go1" style="margin: 0 auto;">
